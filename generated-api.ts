  ...
  constructor() {
    super("Query")
      ...
      cardById<Args extends VariabledInput<{
        ...
        cardId?: string | null | undefined,
      }>, selectorFn: (s: Card) => [...Sel]):$Field<"cardById", GetOutput<Sel> | undefined , GetVariables<Sel, Args>>
 ...
 */
      attack<Args extends VariabledInput<{
        ...
        cardID: Readonly<Array<string>>,
      }>, selectorFn: (s: Card) => [...Sel]):$Field<"attack", Array<GetOutput<Sel>> | undefined , GetVariables<Sel, Args>> {
